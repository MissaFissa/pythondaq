...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.x_yRangesFrame.setStyleSheet(u"background-color: transparent; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 dodgerblue, stop:0.34 black, stop:0.55 dodgerblue, stop:0.98 black, stop:0.99 black, stop:1 black)")
...
"border-radius: 4px;}")
        ...
        self.coloursFrame.setLineWidth(3)

        self.horizontalLayoutColours = QVBoxLayout(self.coloursFrame)
        self.horizontalLayoutColours.setObjectName(u"horizontalLayoutColors")

        self.backgroundColourLineEdit = QLineEdit(self.coloursFrame)
        ...
        self.dataColourLineEdit = QLineEdit(self.coloursFrame)
